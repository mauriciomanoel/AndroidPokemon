package com.mauricio.pokemon.models;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.mauricio.pokemon.models.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.mauricio.pokemon.models.GlideOptions().apply(toSet));
    }
  }
}
